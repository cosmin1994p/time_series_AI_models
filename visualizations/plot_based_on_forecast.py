...
df = pd.read_csv("/Users/cosmin/Desktop/projects/time_series_AI_good_stuff/titans/titans_train_test_predictions.csv")
...
plt.plot(df["timestamp"], df["prediction"], label="Prediction", linestyle="--", linewidth=2)
...
plt.title(" Forecast: Train and Test Predictions vs Actual Load")
